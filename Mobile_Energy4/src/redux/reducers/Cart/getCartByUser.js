import { GET_CART, GET_CART_ERROR, GET_CART_SUCCESS } from "@redux/actions/CartAction";
...
const getCartByUserReducer = (state = initialStale, action) => {
    switch (action.type) {
      //đang đăng nhập
      case GET_CART:
        return {
...
export default getCartByUserReducer;
