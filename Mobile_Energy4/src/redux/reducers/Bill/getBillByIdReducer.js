import { GET_BILL_BY_ID, GET_BILL_BY_ID_ERROR,  GET_BILL_BY_ID_SUCCESS } from "@redux/actions/BillAction";
...
const getBillByIdReducers = (state = initialStale, action) => {
    switch (action.type) {
      //đang đăng nhập
      case GET_BILL_BY_ID:
        return {
...
export default getBillByIdReducers;
